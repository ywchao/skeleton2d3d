...
preds_ = zeros(size(preds.preds,1),3,17);
preds_(:,:,joints) = preds.preds;
preds_(:,:,1) = (preds.preds(:,:,8) + preds.preds(:,:,9))/2;
preds_(:,:,8) = (preds.preds(:,:,2) + preds.preds(:,:,3) + preds.preds(:,:,8) + preds.preds(:,:,9))/4;
preds_(:,:,9) = (preds.preds(:,:,1) + preds.preds(:,:,2) + preds.preds(:,:,3))/3;
preds_(:,:,11) = preds.preds(:,:,1);
preds = preds_;
