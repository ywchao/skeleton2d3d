...
function M.parse(arg)
  ...
  cmd:option('-weightHMap',             1, 'Loss weight for heatmap')
  ...
  cmd:option('-weightLLPrior',          1, 'Loss weight for limb length prior')
  ...
  cmd:option('-hg',                 false, 'Contains hourglass for pose estimation')
  cmd:option('-inputResHG',           256, 'Input image resolution for hourglass')
  ...
  cmd:option('-hgFix',              false, 'Fix parameters of hourglass model ')
  cmd:option('-s3Fix',              false, 'Fix parameters of skel3dnet model ')
  cmd:option('-evalOut',             's3', 'Options: s3 | hg')
